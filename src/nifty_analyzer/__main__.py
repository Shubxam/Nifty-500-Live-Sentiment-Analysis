...
from nifty_analyzer.core import utils
...
from nifty_analyzer.data_ingestion.news_fetcher import (
    TickerNewsObject,
    collect_news_task,
)
...
def get_news(universe: str, multiprocess: bool) -> None:
    ...
    if not multiprocess:
        ...
        with mp.Pool(processes=mp.cpu_count()) as pool:
            ...
            results_list_of_lists: list[list[Article]] = list(
                tqdm(
                    pool.map(
                        collect_news_task, ticker_objs
